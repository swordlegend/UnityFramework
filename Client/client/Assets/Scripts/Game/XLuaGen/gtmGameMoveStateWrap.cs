...
namespace XLua.CSObjectWrap
{
    ...
    public class gtmGameMoveStateWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(gtmGame.MoveState);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<gtmGame.Entity>(L, 2))
				{
					...
					gtmGame.MoveState gen_ret = new gtmGame.MoveState(_entity);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to gtmGame.MoveState constructor!");
        ...
        static int _m_OnEnter(RealStatePtr L)
        {
		    try {
                ...
                gtmGame.MoveState gen_to_be_invoked = (gtmGame.MoveState)translator.FastGetCSObj(L, 1);
