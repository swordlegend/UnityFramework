...
namespace XLua.CSObjectWrap
{
    ...
    public class gtmGameAttackStateWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(gtmGame.AttackState);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<gtmGame.Entity>(L, 2))
				{
					...
					gtmGame.AttackState gen_ret = new gtmGame.AttackState(_entity);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to gtmGame.AttackState constructor!");
        ...
        static int _m_OnEnter(RealStatePtr L)
        {
		    try {
                ...
                gtmGame.AttackState gen_to_be_invoked = (gtmGame.AttackState)translator.FastGetCSObj(L, 1);
