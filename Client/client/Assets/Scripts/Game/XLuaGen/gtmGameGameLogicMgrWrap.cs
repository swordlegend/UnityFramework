...
namespace XLua.CSObjectWrap
{
    ...
    public class gtmGameGameLogicMgrWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(gtmGame.GameLogicMgr);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					gtmGame.GameLogicMgr gen_ret = new gtmGame.GameLogicMgr();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to gtmGame.GameLogicMgr constructor!");
        ...
        static int _m_DoClose(RealStatePtr L)
        {
		    try {
                ...
                gtmGame.GameLogicMgr gen_to_be_invoked = (gtmGame.GameLogicMgr)translator.FastGetCSObj(L, 1);
