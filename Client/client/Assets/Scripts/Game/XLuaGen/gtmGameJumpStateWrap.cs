...
namespace XLua.CSObjectWrap
{
    ...
    public class gtmGameJumpStateWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(gtmGame.JumpState);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 2 && translator.Assignable<gtmGame.Entity>(L, 2))
				{
					...
					gtmGame.JumpState gen_ret = new gtmGame.JumpState(_entity);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to gtmGame.JumpState constructor!");
        ...
        static int _m_OnEnter(RealStatePtr L)
        {
		    try {
                ...
                gtmGame.JumpState gen_to_be_invoked = (gtmGame.JumpState)translator.FastGetCSObj(L, 1);
