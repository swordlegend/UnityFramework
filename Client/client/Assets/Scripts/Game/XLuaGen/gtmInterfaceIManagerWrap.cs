...
namespace XLua.CSObjectWrap
{
    ...
    public class gtmInterfaceIManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(gtmInterface.IManager);
        ...
        {
            return LuaAPI.luaL_error(L, "gtmInterface.IManager does not have a constructor!");
        }
        ...
        static int _m_DoInit(RealStatePtr L)
        {
		    try {
                ...
                gtmInterface.IManager gen_to_be_invoked = (gtmInterface.IManager)translator.FastGetCSObj(L, 1);
