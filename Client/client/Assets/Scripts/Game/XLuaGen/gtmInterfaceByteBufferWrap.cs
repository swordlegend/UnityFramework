...
namespace XLua.CSObjectWrap
{
    ...
    public class gtmInterfaceByteBufferWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(gtmInterface.ByteBuffer);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					gtmInterface.ByteBuffer gen_ret = new gtmInterface.ByteBuffer();
				...
				if(LuaAPI.lua_gettop(L) == 2 && (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING))
				{
					...
					gtmInterface.ByteBuffer gen_ret = new gtmInterface.ByteBuffer(_data);
					translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to gtmInterface.ByteBuffer constructor!");
        ...
        static int _m_ReadBytes(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to gtmInterface.ByteBuffer.ReadBytes!");
