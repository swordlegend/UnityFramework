...
namespace XLua.CSObjectWrap
{
    ...
    public class gtmGameLoginModelWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(gtmGame.LoginModel);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					gtmGame.LoginModel gen_ret = new gtmGame.LoginModel();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to gtmGame.LoginModel constructor!");
        ...
        static int _m_DoInit(RealStatePtr L)
        {
		    try {
                ...
                gtmGame.LoginModel gen_to_be_invoked = (gtmGame.LoginModel)translator.FastGetCSObj(L, 1);
